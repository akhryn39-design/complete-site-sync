      ...
      <div className="flex-1 flex flex-col">
        <div className="flex items-center justify-between p-4 border-b bg-card/50 backdrop-blur">
          ...
          <div className="flex gap-2">
            <Button variant="outline" size="sm" onClick={() => navigate('/materials')} className="gap-2">
              <BookOpen className="h-4 w-4" />
              مواد آموزشی
            </Button>
            <Button variant="outline" size="sm" onClick={() => navigate('/news')} className="gap-2">
        ...
        <ScrollArea className="flex-1 p-4">
          ...
          {messages.length === 0 && !loading && <div className="flex flex-col items-center justify-center h-full text-center p-8">
